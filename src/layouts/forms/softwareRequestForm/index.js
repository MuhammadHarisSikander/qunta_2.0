...
// import Grid from '@mui/material/Grid';
import { Chip, Container, InputLabel, TextField } from "@mui/material";
...
function SoftReqForm() {
    ...
    const submitForm = () => {
        ...
        //     controls_improved: "abc",
        //     man_hours: 12,
        //     other_benefits: "abc",
        //     date: "2022-03-15",
        //     cost_saved: "Testing",
        //     legal_compliance: "Testing",
        //     controls_improve: "Testing"

        // }
        const data = new FormData();

        data.append("request_title", reqTitle);
        data.append("request_specs", reqSpecs);
        data.append("change_type", selectedChangeType);
        data.append("change_priority", selectedChangePrioritye);
        data.append("software_category_id", selectedCategory.id);
        data.append("software_subcategory_id", selectSubCategoty.map(val => val.id));
        data.append("business_expert_id", selectedAffectedModules.map(val => val.id));
        // data.append("attachments", frontPicFile);
        for (var i = 0; i < frontPicFile.length; i++) {
            data.append('attachments[]', frontPicFile[i]);
        }
        data.append("process_efficiency", "abc");
        data.append("controls_improved", "abc");
        data.append("man_hours", 12);
        data.append("other_benefits", "abc");
        data.append("date", "2022-03-15");
        data.append("legal_compliance", "testing");
        data.append("cost_saved", "Testing");
        data.append("controls_improve", "Testing");

        console.log("Image Data", frontPicFile)
                                    ...
                                    <div className="row">
                                        <div className="col-sm-12">
                                            <Box style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', }} sx={{ m: 1 }} >
                                                ...
                                                <FormControl style={{}} sx={{ display: 'flex', flex: 1, mr: 1 }}>
                                                    <Autocomplete
                                                        disablePortal
                                                        id="combo-box-demo"
                                            ...
                                            <Box style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} sx={{ m: 1 }} >
                                                ...
                                                <FormControl style={{}} sx={{ display: 'flex', flex: 1 }}>
                                            ...
                                            <Box sx={{ flexGrow: 1, m: 1 }} style={{ display: 'flex', flex: 1, justifyContent: 'center', alignItems: 'center' }} >
                                                <p style={{ width: "700px" }}>Change Type:</p>
                                            ...
                                            <Box sx={{ flexGrow: 1, m: 1 }} style={{ display: 'flex', flex: 1, justifyContent: 'center', alignItems: 'center' }} >
                                                <p style={{ width: "700px" }} >Change Priority:</p>
                                                <Grid style={{}} item xs={50}>
                                                    <FormControl>
                                                        <RadioGroup
                                                            row
