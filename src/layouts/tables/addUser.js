...
export default function AddUser({ allDesignation, allLocation, allRoles, allDept }) {
    const theme = useTheme();
    const [name, setName] = useState();
    const [email, setEmail] = useState();
    const [password, setPassword] = useState();
    const [confirmPassword, setConfirmPassword] = useState();
    const [employeeNo, setEmployeeNo] = useState("qm-11111");
    const [employeeType, setEmployeeType] = useState("Permamnent");
    const [extension, setExtension] = useState("2156");
    const [phone, setPhone] = useState("0211223456");
    ...
    // React.useEffect(() => {
    //     console.log("UseEffect Data ", selectedDesignation)
